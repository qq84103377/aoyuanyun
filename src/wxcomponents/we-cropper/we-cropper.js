...
(function(global, factory) {
  ...
  function prepare() {
    ...
    self.createCtx = function() {
      ...
      if (id) {
        // 坑
        self.ctx = self.ctx || wx.createCanvasContext(id, self._this);
        self.targetCtx = self.targetCtx || wx.createCanvasContext(targetId, self._this);
      } else {
    ...
    self.getCropperImage = function(opt, fn) {
      ...
      return task()
        .then(function() {
          ...
          // 坑,必须传入 Component this
          var arg = canvasOptions.componentContext ? [canvasOptions, self._this] : [canvasOptions];
